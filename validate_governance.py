...
def validate_repo() -> int:
    ...
    # Governance checks
    checks.append(
        check_file(f"{repo_path}/.phenotype/ai-traceability.yaml", "AI attribution")
    )
    checks.append(
        check_file(f"{repo_path}/.github/workflows/traceability.yml", "CI/CD workflow")
    )
