...
p.add_argument("--lead-key", default="lead_time_hours")
p.add_argument("--min-lead-hours", type=float, default=0.0)
...
if breaches > a.max_breaches:
    print("B75 attestation lead time gate failed", file=sys.stderr)
    raise SystemExit(2)
